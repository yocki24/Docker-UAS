        ...
        <div class="col-md-6">
            <div class="card shadow rounded">
                <div class="card-header">
                    <h5 class="m-0 card-title">Form Edit Data Admin</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('admin.auth.update', $data->id)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nisn') is-invalid @enderror" name=" nisn" id="nisn" placeholder="Masukkan NISN/NIP" value="{{ $data->nisn}}">
                            @error('nisn')
                        ...
                        <div class="mb-3">
                            ...
                            <select id="status" name="status" class="form-control @error('status') is-invalid @enderror">
                                ...
                                <option value="siswa" {{$data->status === 'siswa' ? 'selected' : '' }}>Siswa</option>
