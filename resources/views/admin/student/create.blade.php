        ...
        <div class="col-md-6">
            <div class="card shadow rounded">
                <div class="card-header">
                    <h5 class="m-0 card-title">Form Tambah Data Siswa</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('admin.auth.register')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nisn') is-invalid @enderror" name=" nisn" id="nisn" placeholder="Masukkan NISN" value="{{old('nisn')}}">
                            @error('nisn')
